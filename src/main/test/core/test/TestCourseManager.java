...
public class TestCourseManager {
	...
	public void testCapacityZero() {
		courseManager.createClass("ECS161", 2017, "Instructor", 0);
		assertFalse(courseManager.classExists("ECS161", 2017));
	}
	
	@Test
	public void testCapacityBelowZero() {
		courseManager.createClass("ECS161", 2017, "Instructor", -1);
		assertFalse(courseManager.classExists("ECS161", 2017));
	}
	
	@Test
	public void testCapacityThousand() {
		courseManager.createClass("ECS161", 2017, "Instructor", 1000);
		assertFalse(courseManager.classExists("ECS161", 2017));
	}
	
	@Test
	public void testCapacityAboveThousand() {
		courseManager.createClass("ECS161", 2017, "Instructor", 1001);
		assertFalse(courseManager.classExists("ECS161", 2017));
	}
}
